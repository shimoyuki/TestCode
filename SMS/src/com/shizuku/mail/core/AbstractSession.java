...
public abstract class AbstractSession implements Session {
    ...
    /**
     * @see com.shizuku.mail.Service.Session#getClinetSocket()
    ...
    /**
     * @see com.shizuku.mail.Service.Session#setClientSocket(Socket socket)
     */
    ...
    /**
     * 
     * @see com.shizuku.mail.Service.Session#readCommandLine()
    ...
    /**
     * @see com.shizuku.mail.Service.Session#readLine()
    ...
    /**
     * @see com.shizuku.mail.Service.Session#writeResponse(String response)
     *      Response to client
     * 
     * @param response
     *            the string
    ...
    /**
     * @see com.shizuku.mail.Service.Session#getOperation()
     * 
    ...
    /**
     * @see com.shizuku.mail.Service.Session#addOperation(String name, Object
     *      value)
     * @param name
     *            Operation name
     * @param value
    ...
    /**
     * @see com.shizuku.mail.Service.Session#clear() Clear Operation which recoed
     *      in hasp map
     */
    public void clear() {
        this.map.clear();
    ...
    /**
     * @see com.shizuku.mail.Service.Session#getLastAction() Get Last command
     *      value(Integer)
    ...
    /**
     * @see com.shizuku.mail.Service.Session#setLastAction(int lastAction) Set Last
     ...
     * connection.
     * 
     * @see com.shizuku.mail.Service.Session#close() Close current session.
     */
    public void close() {
        try {
            if (pw != null) {
    ...
    /**
     * @see com.shizuku.mail.Service.Session#getCommandLine()
