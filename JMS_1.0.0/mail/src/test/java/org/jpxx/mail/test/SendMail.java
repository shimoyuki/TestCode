 ...
 *
 * @author Jun Li
 * @version $Revision: 0.0.3 $, $Date: 2008/10/29 $
 * @since JMS 0.0.3
 */
public class SendMail {
    ...
    public static boolean send(String to, String subject, String message) {
        ...
        String pass = "system";
        String mail = "test@test.org";
        return send(user, pass, mail, to, smtp, subject, message);
    }

    public static boolean send(final String user, final String pass, String fromAddr,
                               String toAddr, String host, String subject, String message) {
        try {
            ...
            props.put("mail.smtp.from", "test@test.org");
